...
<div style="display: flex; justify-content: center;">
  <button onclick="trocar2()">Cadastro</button>
  <button onclick="trocar()">Login</button>
</div>
<br>
<div id="div1" class="container-xxl">
  <div class="container-a">
    <form class="b-container">
      ...
      <div class="input-group mb-3">
        <span  style="color: white;"class="input-group-text" id="basic-addon2">Nome de usuário</span>
      ...
      <div class="mb-3">
        <div class="input-group">
          <span style="color: white;" class="input-group-text" id="basic-addon3">Telefone</span>
          <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3 basic-addon4" placeholder="(00)00000-0000">
        </div>
      ...
      <div class="input-group mb-3">
        <span style="color: white;" class="input-group-text">Data de Nascimento</span>
      ...
      <div  class="input-group mb-3">
        ...
        <button style="background: linear-gradient(to right, rgb(0, 97, 154), rgb(18, 138, 243), rgb(5, 209, 250));;" type="submit" class="btn btn-primary">Enviar</button>
      </div>
    </form>
    <div style="z-index:1; width: 50%; height: 100%;background:linear-gradient(to right, rgb(0, 97, 154), rgb(18, 138, 243), rgb(5, 209, 250)); margin-left:0;" class="container"  >
...
<div class="container-xxl-2">
  <div class="container-a">
    ...
    <form class="b-container-2">
      ...
      <div style="width: 100%;display:flex; justify-content:space-aroud; align-items: center;"  class="container-3-apps">
